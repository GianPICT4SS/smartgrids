...
try:
    ...
    sys.path.append('/Users/gianpiodomiziani/Desktop/ICT4SS/inter_project/smartgrids/src/')
    from common.config import *
    
    
def process_file(fname):
    file_name = "/Users/gianpiodomiziani/Desktop/20191105MGPPrezziConvenzionali.xml"
